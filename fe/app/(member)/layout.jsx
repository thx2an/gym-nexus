...
import CompleteProfileModal from "@/components/member/CompleteProfileModal"
...
export default function MemberLayout({ children }) {
  ...
  const navGroups = [
    ...
    },
    {
      title: "Support",
      items: [
        { href: "/member-support/tickets", label: "Support Tickets", icon: LifeBuoy },
        { href: "/chat", label: "Chat with Trainer", icon: MessageSquare },
      ],
    },
  ]
