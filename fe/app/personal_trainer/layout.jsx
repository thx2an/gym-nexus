...
import PTEditProfileModal from "@/components/personal_trainer/PTEditProfileModal"
...
export default function PersonalTrainerLayout({ children }) {
  ...
  // Mock user data for the modal
  const mockUserData = {
    name: "John Doe",
    phone: "+1 (555) 123-4567",
    address: "123 Main St, Gym City, GC 54321"
  }
  ...
  const navGroups = [
    ...
    },
    {
      ...
      items: [
        { href: "/personal_trainer/progress", label: "Clients & Progress", icon: Users },
    ...
    },
    {
      ...
      items: [
        ...
        { href: "/personal_trainer/availability", label: "Availability", icon: Clock },
      ],
    },
    {
      title: "Communication",
      items: [
        { href: "/personal_trainer/feedback", label: "Feedback", icon: MessageSquare },
      ],
    },
  ]
